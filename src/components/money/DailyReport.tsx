              ...
              <TableBody>
                {customersToday.map(c => (
                  <TableRow key={c.customer}>
                    <TableCell className="font-medium align-top">{c.customer}</TableCell>
                    <TableCell className="text-sm">
                      {c.lines.map((l, i) => (
                        <span key={i} className="inline-block mr-3 mb-1">
                          <span className="font-semibold">{l.qty}</span>&times; {l.product} <span className="text-muted-foreground">({l.unit})</span>
                        </span>
                      ))}
                    </TableCell>
                  </TableRow>
